    ...
    return (
        <Dialog open={isOpen} onClose={onClose}>
            ...
            <DialogContent>
                ...
                <AboutDialogText>When WaniKani integration is enabled, the displayed sentences are provided by <Link target="_blank" rel="noopener" href="http://www.tofugu.com/">Tofugu</Link>{`'s kanji learning website `}<Link target="_blank" rel="noopener" href="http://www.wanikani.com/">WaniKani</Link> through their API.</AboutDialogText>
